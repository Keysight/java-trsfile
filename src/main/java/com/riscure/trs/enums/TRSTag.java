...
public enum TRSTag {
    ...
    TRACE_SET_PARAMETERS             (0x76, "GP", false,    TraceSetParameterMap.class, 0, new TraceSetParameterMap(),                 "The set of custom global trace set parameters"),
    TRACE_PARAMETER_DEFINITIONS      (0x77, "LP", false,    TraceParameterDefinitionMap.class, 0, new TraceParameterDefinitionMap(),                 "The set of custom local trace parameters");
